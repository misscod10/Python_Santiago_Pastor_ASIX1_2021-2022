...
def main(nombre_protagonista):
    """
    Aquest programa rep un nombre com a paràmetre i retorna la seva taula de multiplicar en forma de cadena de text.
    >>> print(main(5))
    5 x 1 = 5
    5 x 2 = 10
    5 x 3 = 15
    ...
    taula_result = ""
    for i in range(1,11):
        taula_result+= f"{nombre_protagonista} x {i} = {nombre_protagonista*i}\n"
    return taula_result
