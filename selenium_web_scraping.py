...
def main():
    ...
    elem = driver.find_element(By.ID, 'login_field').send_keys("cf19santiago.pastor@iesjoandaustria.org")
    elem = driver.find_element(By.ID, 'password').send_keys("MaNF48Fc")
